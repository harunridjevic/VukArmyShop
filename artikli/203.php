...
<html>
        <head>
            ...
            <title>TAKTIČKI PREKLOPNI NOŽ</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/203_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/203_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>TAKTIČKI PREKLOPNI NOŽ</h1>
    <h2>39.99 KM</h2>
    <hr>
    <p>TAKTIČKI PREKLOPNI NOŽ

📃 Opis:
Dimenzije: drška 13cm, oštrica 10cm, težina 250g
Dostupne boje: maskirna
Karakteristike: nož idealan za lov, ljubitelje prirode, kampere, pecaroše poseduje zakačku za opasač ili džep 
