...
<html>
        <head>
            ...
            <title>⚠️TERENSKI SET ZA KUVANJE⚠️</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/109_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/109_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>⚠️TERENSKI SET ZA KUVANJE⚠️</h1>
    <h2>64.99 KM</h2>
    <hr>
    <p>⚠️TERENSKI SET ZA KUVANJE⚠️ 

📃 Opis:
Materijal: nehrđajući čelik
Dimenzije: velika posuda 15 x 9cm, poklopac(tiganj) 15,5 x3,5 cm i mala posuda 13 x 8cm
Karakteristike: lagana, izdržljiva, teži 440g idealna za planinare, kampere, lovce i ljubitelje prirode 
