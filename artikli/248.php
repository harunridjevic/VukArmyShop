...
<html>
        <head>
            ...
            <title>CRNE ENTER TAKTIČKE PANTALONE</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/248_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/248_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>CRNE ENTER TAKTIČKE PANTALONE</h1>
    <h2>124.99 KM</h2>
    <hr>
    <p>CRNE ENTER TAKTIČKE PANTALONE

📃 Opis:
Materijal: Ripstop
Veličine: M- XXXL
Dostupne boje: crna
Karakteristike: vodoodbojne, vetronepropusne i uljnoodbojne, veliki broj džepova, čičak za zatezanje na kolenima i člancima, ykk zibzar i čičak, mesto za protektore na kolenima ojačano kordurom, mesto za amblem na džepu, amblem nije uključen u cijenu
