...
<html>
        <head>
            ...
            <title>ZELENA IFAK TORBICA ZA PRVU POMOĆ</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/268_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/268_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>ZELENA IFAK TORBICA ZA PRVU POMOĆ</h1>
    <h2>59.99 KM</h2>
    <hr>
    <p>ZELENA IFAK TORBICA ZA PRVU POMOĆ 

📃 Opis:
Materijal: 100% poliester
Dimenzije: 16cm×18cm×8cm
Dostupne boje: crna i zelena
Karakteristike: džep sa pregradama i gurtnom za komplet prve pomoći, izdržljiva, praktična i poseduje čičak za oznaku, dolazi u kompletu sa oznakom prve pomoći idealna za lov, planinarenje i boravak u prirodi, molle sistem kačenja, torbica dolazi bez kompleta prve pomoći
