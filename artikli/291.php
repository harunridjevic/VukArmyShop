...
<html>
        <head>
            ...
            <title>KAMUFLAŽNA MREŽA MASKIRNA </title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/291_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/291_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>KAMUFLAŽNA MREŽA MASKIRNA </h1>
    <h2>149.99 KM</h2>
    <hr>
    <p>KAMUFLAŽNA MREŽA MASKIRNA 

📃 Opis:
Materijal: 100% poliester
Dimenzije: 2x3m
Dostupne boje: maskirna
Karakteristike: otporna na UV zrake, težina 3kg, pogodna za čeku i kamufliranje u lovu ili airsoftu, takođe za pravljenje zasene u letnjem periodu, na uglovima ima petlje za pričvršćivanje, vrhunski kvslitet izrade, cena je za jednu mrežu 
