...
<html>
        <head>
            ...
            <title>TORBA ZA LOVAČKE ČIZME </title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/314_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/314_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>TORBA ZA LOVAČKE ČIZME </h1>
    <h2>44.99 KM</h2>
    <hr>
    <p>TORBA ZA LOVAČKE ČIZME 

📃 Opis:
Materijal: kordura
Težina: 400g
Dostupne boje: zelena
Karakteristike: torba idealna za transport čizama u vozilu i na terenu, izdržljiva i praktična za upotrebu, poseduje ventilacionu mrežiću 
