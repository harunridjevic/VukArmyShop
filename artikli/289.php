...
<html>
        <head>
            ...
            <title>TAKTIČKA PALICA BATON</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/289_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/289_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>TAKTIČKA PALICA BATON</h1>
    <h2>69.99 KM</h2>
    <hr>
    <p>TAKTIČKA PALICA BATON 

📃 Opis:
Materijal: čelik
Dimenzije: sklopljena: 20cm opružena: 54cm
Dostupne boje: crna
Karakteristike: težina 520g, drška od mekog pvc materijala je protuklizna, dolazi u kompletu sa futrolom od kordure koja se može nositi na opasaču, veoma kvalitetna i izdržljiva, nevedena cijena je ta jednu palicu 
