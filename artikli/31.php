...
<html>
        <head>
            ...
            <title>Maskirna taktička softshell jakna</title>
            <style>
                img {
...
.demo:hover {
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/31_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/31_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>Maskirna taktička softshell jakna</h1>
    <h2>89.99 KM</h2>
    <hr>
...
Dostupne boje: crna, siva, zelena, woodland, maskirna, dark camo i marpat
