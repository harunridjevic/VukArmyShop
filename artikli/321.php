...
<html>
        <head>
            ...
            <title>MORA BASIC 511 NOŽ YELLOW</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/321_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/321_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>MORA BASIC 511 NOŽ YELLOW</h1>
    <h2>19.99 KM</h2>
    <hr>
    <p>MORA BASIC 511 NOŽEVI 

📃 Opis:
Dimenzije: ukupna dužina 22.4cm, oštrica 9.1cm, debljina sečiva 2.0cm,  težina 110g
Dostupne boje: žuta i crvena
Karakteristike: nož proizveden u Švedskoj idealan za lov, ljubitelje prirode, kampere, pecaroše poseduje futrolu za nošenje na opasaču ili rancu, nož izrađen od karbonskog čelika
