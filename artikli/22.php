...
.demo:hover {
  opacity: 1;
		...
		<body>
  		...
  		int j = 3;
  		for(int i=1;i<=j;i++){
  			document.getElementById("containter").innerHTML = "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='assets/22_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>"
  		}
  	</script>
  ...
  <div class="row" id="row">
  	<script>
  		int j = 3;
  		for(int i=1;i<=j;i++){
  			document.getElementById("row").innerHTML = "<div class='column'><img class='demo cursor' src='assets/22_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;'onclick='"'currentSlide(1)'"' alt='"'The Woods'"'></div>"
  		}
  	</script>
  </div>
</div></div>
