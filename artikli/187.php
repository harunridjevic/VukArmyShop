...
<html>
        <head>
            ...
            <title>CHEST RIG -TAKTIČKI PRSLUK </title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/187_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/187_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>CHEST RIG -TAKTIČKI PRSLUK </h1>
    <h2>59.99 KM</h2>
    <hr>
    <p>CHEST RIG -TAKTIČKI PRSLUK

📃 Opis:
Materijal: kordura
Dimenzije: univerzalna
Dostupne boje: crna
Karakteristike: izdržljivost, praktičnost, prsluk teži 1.5kg, sve torbice idu u kompletu sa prslukom, traka čičak za oznake, izuzetno prijatan za nošenje idealan za taktičku primenu i boravak u prirodi 
