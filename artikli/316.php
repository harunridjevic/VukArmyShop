...
<html>
        <head>
            ...
            <title>SEF ZA ORUŽIJE I MUNICIJU</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/316_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/316_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>SEF ZA ORUŽIJE I MUNICIJU</h1>
    <h2>74.99 KM</h2>
    <hr>
    <p>SEF ZA ORUŽIJE I MUNICIJU 

📃 Opis:
Materijal: čelik
Dimenzije: 27cm x 22cm x 22cm
Dostupne boje: crna
Karakteristike: sef ima 6 mjeseci garancije, namjenjen za zaštitu vrednosnih hartija, pištolja, municije, novca, nakita i drugih dragocenosti, 2 koraka obezbeđenja šifra i ključ, sef se može pričvrstiti za pod, ormar ili zid 
