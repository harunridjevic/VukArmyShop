...
<html>
        <head>
            ...
            <title>CRNE CARGO TAKTIČKE PANTALONE</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/251_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/251_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>CRNE CARGO TAKTIČKE PANTALONE</h1>
    <h2>69.99 KM</h2>
    <hr>
    <p>CRNE CARGO TAKTIČKE PANTALONE

📃 Opis:
Materijal: Ripstop
Veličine: M- XXXL
Dostupne boje: crna i zelena
Karakteristike: mehanički otporne, vodoodbojne, mesto za amblem, veliki broj džepova(2 džepa napred, 2 na butini, dva bočno, 2 pozadi, 2 na nogavicama), čičak za zatezanje na kolenima i člancima i mesto za protektore na kolenima, navedena cijena je za jedne pantalone i amblem nije uključen u cijenu
