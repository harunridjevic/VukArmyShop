...
<html>
        <head>
            ...
            <title>SILKY BIG BOY PREKLOPNA TESTERA </title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/325_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/325_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>SILKY BIG BOY PREKLOPNA TESTERA </h1>
    <h2>239.99 KM</h2>
    <hr>
    <p>SILKY BIG BOY PREKLOPNA TESTERA 

📃 Opis:
Dimenzije: ukupna dužina rasklopljene testere 76cm x 9cm x 2cm, oštrica 36cm,  težina 478g
Karakteristike: testeta  proizvedena u Japanu idealna za lov, ljubitelje prirode, kampere, pecaroše poseduje futrolu za nošenje u rancu, testera izrađena od vrhunskog čelika 
...
Stojimo Vam na raspolaganju za sva pitanja i informacije. Vaš Vuk Army Shop!
