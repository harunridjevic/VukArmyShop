...
<html>
        <head>
            ...
            <title>MORA COMPANION NOŽ ARMY GREEN</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/324_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/324_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>MORA COMPANION NOŽ ARMY GREEN</h1>
    <h2>34.99 KM</h2>
    <hr>
    <p>MORA COMPANION NOŽEVI 

📃 Opis:
Dimenzije: ukupna dužina 22cm, oštrica 10.4cm, debljina sečiva 2.5cm,  težina 117g
Dostupne boje: zelena, tan i crna
Karakteristike: nož proizveden u Švedskoj idealan za lov, ljubitelje prirode, kampere, pecaroše poseduje futrolu za nošenje na opasaču ili rancu, nož izrađen od nehrđajućeg čelika 
