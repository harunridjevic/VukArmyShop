...
<html>
        <head>
            ...
            <title>CHEM LIGHT TAKTIČKI SVETLEĆI ŠTAPIĆI </title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/313_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/313_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>CHEM LIGHT TAKTIČKI SVETLEĆI ŠTAPIĆI </h1>
    <h2>9.99 KM</h2>
    <hr>
    <p>CHEM LIGHT TAKTIČKI SVETLEĆI ŠTAPIĆI 

📃 Opis:
Dimenzije: 15cm X 1,5cm
Dostupne boje: više boja
Karakteristike: idealna za airsoft, lov, taktičku upotrebu, boravak u prirodi, planinarenje, kampovanje, duzina trajanja svetla 12 sati 
