...
<html>
        <head>
            ...
            <title>TAKTIČKI POD OPASAČ</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/209_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/209_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>TAKTIČKI POD OPASAČ</h1>
    <h2>44.99 KM</h2>
    <hr>
    <p>TAKTIČKI POD OPASAČ

📃 Opis:
Materijal: kordura i ykk čičak
Dimenzije: širina 4cm dužina podesiva do 140cm
Dostupne boje: crna i zelena
Karakteristike: izdržljiv, praktičan, podesiv, atestiran na 10000 otvaranja, idealan za taktičku upotrebu
