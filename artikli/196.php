...
<html>
        <head>
            ...
            <title>APARAT ZA GAŠENJE POŽARA</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/196_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/196_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>APARAT ZA GAŠENJE POŽARA</h1>
    <h2>54.99 KM</h2>
    <hr>
    <p>APARAT ZA GAŠENJE POŽARA

📃 Opis:
Težina: 1kg
Namena: gašenje požara u ranoj fazi
Karakteristike: lagan, pogodan za transport, poseduje nosač, idealan za vozila i upotrebu u domovima, takođe odličan deo opreme za kampere i kamp prikolice 
