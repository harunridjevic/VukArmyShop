...
<html>
        <head>
            ...
            <title>ZAŠTITNI KOFER ZA OPREMU</title>
            <script>
...
<span style="font-size:7vh;cursor:pointer;float:right;margin:3vh" id="open_nav_button" onclick="openNav()">&#9776;</span>
  ...
  let containerHTML = "";
  for(let i = 1; i <= j; i++){
    containerHTML += "<div class='mySlides'><div class='numbertext'>"+i+" / "+j+"</div><img src='/uploads/197_"+i+".jpg' style='height:470px;max-width:100%;object-fit: cover;'></div>";
  }
  ...
  let rowHTML = "";
  for(let i = 1; i <= j; i++){
    rowHTML += "<div class='column'><img class='demo cursor' src='/uploads/197_"+i+".jpg' style='width:100%;height:125px;object-fit: cover;' onclick='currentSlide("+i+")' alt='The Woods'></div>";
  }
...
<div id="article-info-part">
    <h1>ZAŠTITNI KOFER ZA OPREMU</h1>
    <h2>139.99 KM</h2>
    <hr>
    <p>ZAŠTITNI KOFER ZA OPREMU

📃 Opis:
Materijal: PVC
Dimenzije: 339mm×295mm×152mm
Dostupne boje: crna
Karakteristike: vodootporan, izuzetno čvrst, težina 1.8kg, izdržljiv, praktična, idealna za lov, planinarenje i boravak u prirodi 
